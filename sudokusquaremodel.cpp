...
const std::vector<std::string> SudokuSquareModel::squareG{"G1","G2","G3","H1","H2","H3","H1","H2","H3"};
const std::vector<std::string> SudokuSquareModel::squareH{"G4","G5","G6","H4","H5","H6","H4","H5","H6"};
const std::vector<std::string> SudokuSquareModel::squareI{"G7","G8","G9","H7","H8","H9","H7","H8","H9"};
